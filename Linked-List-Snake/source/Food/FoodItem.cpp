...
namespace Food
{
    ...
    FoodItem::FoodItem() { food_image = new ImageView(); }

    FoodItem::~FoodItem() { delete food_image; }
    ...
    void FoodItem::update() { food_image->update(); }

    void FoodItem::render() { food_image->render(); }

    FoodType FoodItem::getFoodType() { return food_type; }
