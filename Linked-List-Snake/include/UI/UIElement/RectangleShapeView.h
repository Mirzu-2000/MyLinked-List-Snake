...
namespace UI
{
	namespace UIElement
	{
		...
		public:
			...
			virtual void initialize(sf::Vector2f rectangl_size, sf::Vector2f rectangle_position, int outline_thickness = 0, sf::Color fill_color = sf::Color::Transparent, sf::Color outline_color = sf::Color::Transparent);
